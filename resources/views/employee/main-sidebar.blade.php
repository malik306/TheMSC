<aside class="main-sidebar sidebar-dark-primary elevation-4 h-auto">
    <!-- Brand Logo -->
    <a href="{{url('/faculty')}}" class="brand-link">
        <img src="{{asset('/employee/'. $self->profile->image)}}" class="brand-image img-circle elevation-3"
             style="opacity: .8;">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview menu-open">
                    <a href="/faculty" class="nav-link active">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/faculty/self-attendance" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>
                                    Self
                                </p>
