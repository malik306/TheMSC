    ...
    <div class="card rounded m-auto w-50">
        ...
        <div class="card-body">
            <form action="{{route('experience.store')}}" method="post">
                ...
                <div class="form-group">
                    <div class="form-label-group">
                        <input id="duration" type="date" class="form-control @error('duration') is-invalid @enderror" name="duration" value="{{ old('duration') }}" required autocomplete="duration" autofocus>
